...
public class Query {
     ...
     */
    public Cliente queryClienteWithCodCliente(Integer cod_cliente) { return clienteQueries.queryClienteWithCodCliente(cod_cliente); }

    /*
    ! Consulta cliente de tipo pessoa física e seus dados utilizando código de cliente.
     */
    public Pessoa_Fisica queryPessoaFisicaWithCodCliente(Integer cod_cliente) { return clienteQueries.queryPessoaFisicaWithCodCliente(cod_cliente); }

    /*
    ! Consulta cliente de tipo pessoa jurídica e seus dados utilizando código de cliente.
     */
    public Pessoa_Juridica queryPessoaJuridicaWithCodCliente(Integer cod_cliente) { return clienteQueries.queryPessoaJuridicaWithCodCliente(cod_cliente); }
