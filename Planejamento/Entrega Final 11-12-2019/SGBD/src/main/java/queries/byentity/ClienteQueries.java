...
public class ClienteQueries {
     ...
     */
    public Cliente queryClienteWithCodCliente(Integer cod_cliente)
    {
        try {
            String jpql = "SELECT c FROM Cliente c WHERE c.cod_cliente = :cod_cliente";
            TypedQuery<Cliente> typedQuery = em.createQuery(jpql, Cliente.class);
     ...
     */
    public Pessoa_Fisica queryPessoaFisicaWithCodCliente(Integer cod_cliente)
    {
        try{
     ...
     */
    public Pessoa_Juridica queryPessoaJuridicaWithCodCliente(Integer cod_cliente)
    {
        try{
